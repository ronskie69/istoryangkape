...
app.use(session({
    ...
    proxy: true,
    name: 'nogsuuu',
    secret: process.env.SESSION_SECRET || "nogsuuu",
    unset: 'destroy',
    cookie: {
...
const DB = "mongodb+srv://nugsuu:Sunogan33!@cluster0.uiqs1.mongodb.net/story_app" || process.env.DB;
